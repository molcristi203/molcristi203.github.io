...
const SectionTitle = forwardRef<HTMLDivElement, Props>(
    ...
    return (
        <div ref={ref} className="sm:p-8 p-4 bg-bh_yellow text-white lg:text-5xl md:text-4xl sm:text-4xl text-2xl border-b-2 border-black flex flex-row flex-nowrap gap-2 items-center" data-navname={title}>
