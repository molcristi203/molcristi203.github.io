...
export default function RobotArm() {
    return (
        <div>
            ...
            <Section left={[<p key={0}>Arduino project built by a team of 2 based on <a href="https://howtomechatronics.com/tutorials/arduino/diy-arduino-robot-arm-with-smartphone-control/" target="_blank" className="text-bh_yellow">this project.</a></p>,
            ...
            <SingleSection>
                <a href="https://github.com/molcristi203/robotic-arm" target="_blank" className="text-bh_yellow">GitHub Repository</a>
            </SingleSection>
